 ...
 Thread.sleep(3000);
   ...
   public void CreateNewPremise(String Action) throws IOException, InterruptedException, AWTException{
    ...
    for (int i = 0;i < tableMap.get("AccountType").size();i++) {
  	  ...
  	  if (sType.equals("SPAREPAIR")||sType.equals("BTWLTNONUMRET")||sType.equals("BTWLTNUMRET")||sType.equals("MPFWLTNUMRET")||sType.equals("MPFWLTNONUMRET")||sType.equals("BTRESTARTSTOPPED")||sType.equals("MPFRESTARTSTOPPED")||sType.equals("BTRESTARTSTOPPED")||sType.equals("NOLINEPLANT")||sType.equals("THROTTLEDFIBRE")||sType.equals("PSTNWLNUMRET")||sType.equals("BTRESTARTSTOPPEDEBU")||sType.equals("PreOrderStandardFTTH")||sType.equals("PreOrderNonStandardFTTH")||sType.equals("PreOrderExtendedStandardFTTH")||sType.equals("BlankNonStandardFTTH")||sType.equals("BlankExtendedStandardFTTH") )
  	  {
